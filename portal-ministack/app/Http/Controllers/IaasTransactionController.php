...
{
    /**
     * Objek layanan untuk berinteraksi dengan MiniStack lokal.
     */
    protected $miniStackService;

    public function __construct(MiniStackService $miniStackService)
    {
    ...
    public function verifyPayment($paymentId)
    {
        ...
        if ($payment->status_bayar === 'Lunas') {
            return response()->json(['message' => 'Nota pembayaran ini telah diverifikasi sebelumnya.'], 400);
        }
        ...
        try {
            ...
            $subscription->update(['status' => 'active']); // Aktivasi status kontrak sewa
